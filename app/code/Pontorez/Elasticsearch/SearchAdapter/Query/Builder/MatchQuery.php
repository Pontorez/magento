...
namespace Pontorez\Elasticsearch\SearchAdapter\Query\Builder;
 ...
 */
class MatchQuery implements \Magento\Elasticsearch\SearchAdapter\Query\Builder\QueryInterface
{
    /**
    ...
    public function build(array $selectQuery, RequestQueryInterface $requestQuery, $conditionType)
    {
        ...
        \Pontorez\Helper::fixQueryForAjaxSuggestions($selectQuery, $queryValue); //mod-here
        return $selectQuery;
    }
